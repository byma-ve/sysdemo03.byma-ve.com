...
export default function DashboardStatsGrid({ idArea, idCliente, idYear }) {
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/totalRecojos.php?id_cliente=${idCliente}&id_area=${idArea}&id_year=${idYear}`
    )
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/totalGuias.php?id_cliente=${idCliente}&id_area=${idArea}&id_year=${idYear}`
    )
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/totalDespachos.php?id_cliente=${idCliente}&id_area=${idArea}&id_year=${idYear}`
    )
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/totalMotivados.php?id_cliente=${idCliente}&id_area=${idArea}&id_year=${idYear}`
    )
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/totalEntregados.php?id_cliente=${idCliente}&id_area=${idArea}&id_year=${idYear}`
    )
      .then((response) => response.json())
  ...
  async function descargarExcelGuias() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/exportarGuias.php`;
      ...
      const apiUrl2 = `https://sysdemo03.byma-ve.com/BackendApiRest/Dashboard/exportarGuiasTotales.php`;
  ...
  async function descargarExcelRecojos() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/ListaRecojos/obtenerListaRecojos.php`;
      const apiResponse = await fetch(apiUrl, {
        method: "GET",
      });
      const apiData = await apiResponse.json();
  ...
  async function descargarExcelDespachos() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Seguimiento/exportarDespachos.php`;
      const apiResponse = await fetch(apiUrl, {
        method: "GET",
      });
      const apiData = await apiResponse.json();
  ...
  async function descargarExcelMotivados() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Seguimiento/exportarMotivados.php`;
      const apiResponse = await fetch(apiUrl, {
        method: "GET",
      });
      const apiData = await apiResponse.json();
  ...
  async function descargarExcelEntregados() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Seguimiento/exportarEntregados.php`;
      const apiResponse = await fetch(apiUrl, {
        method: "GET",
      });
      const apiData = await apiResponse.json();
