...
export const Configuracion = ({
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Permisos/obtenerPermisos.php?dni_usuario=${dni_usuario}`
    )
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Permisos/editarPermisos.php",
        {
          method: "POST",
          headers: {
