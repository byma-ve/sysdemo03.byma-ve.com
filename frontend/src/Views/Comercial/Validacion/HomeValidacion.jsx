...
function HomeValidacion() {
  ...
  const exportarValidaciones = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Validacion/exportarValidaciones.php"
      );
  ...
  const cargarTabla = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Validacion/obtenerValidaciones.php"
      );
      const data = await response.json();
  ...
  const desaprobarValidacion = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Validacion/desaprobarValidacion.php?id_cotizacion=${id}&id_usuario=${localStorage.getItem(
          "id_usuario"
        )}`,
        {
          method: "GET",
  ...
  const aprobarValidacion = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Validacion/aprobarValidacion.php?id_cotizacion=${id}&id_usuario=${localStorage.getItem(
          "id_usuario"
        )}`,
        {
          method: "GET",
