...
function PuntosVenta() {
  ...
  const cargarListaEnvios = async () => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/PuntoVenta/obtenerListaDestinos.php?id_cliente=${clienteElegido}&id_area=${areaElegida}`
      );
  ...
  const fetchData = async () => {
    if (clienteElegido && areaElegida) {
      try {
        const response = await fetch(
          `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/PuntoVenta/obtenerCalculoTotal.php?id_cliente=${clienteElegido}&id_area=${areaElegida}`
        );
        const data = await response.json();
        setDataEnvio(data);
      } catch (error) {
  ...
  const cargarTabla = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/PuntoVenta/obtenerCotizaciones.php"
      );
      const data = await response.json();
  ...
  const eliminarCotizacion = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/PuntoVenta/eliminarCotizacion.php?id_cotizacion=${id}`,
        {
          method: "GET",
        }
      );
