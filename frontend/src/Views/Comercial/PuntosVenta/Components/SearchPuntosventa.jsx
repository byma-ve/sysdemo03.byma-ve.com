  ...
  const handleGenerarCotizacion = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/PuntoVenta/guardarCotizacion.php",
        {
          method: "POST",
          headers: {
      ...
      <div className="-mt-[8px] pb-3 w-full ">
        <div className="text-white grid h-full w-full items-center  grid-cols-[auto,2fr,auto] justify-between bg-var(--gris) ">
          ...
          <div className="relative flex  ml-10">
            <button
              className={`p-3 mx-2 h-10 text-xl text-white bg-[rgba(255,255,255,0.2)] hover:bg-[rgba(255,255,255,0.5)] 
