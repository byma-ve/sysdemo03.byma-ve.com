...
function ModalEditar({
  ...
  // UseEffect to fetch departamentos
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Cotizacion/totalTarifa.php`,
          {
            method: "POST",
            headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Cotizacion/cargosAdicionales.php`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    if (id_cliente && id_area && id_destino_cotizacion) {
      try {
        const response = await fetch(
          "https://sysdemo03.byma-ve.com/BackendApiRest/Comercial/Cotizacion/editarDestino.php",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
