...
import NavBarConsultas from "./Components/NavBarConsultas";
function HomeConsultas() {
  ...
  const cargarRegistros = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Consultas/obtenerConsultas.php"
      );
  ...
  const cargarDatosConsulta = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Consultas/obtenerConsulta.php?id_num_guia=${value}`
      );
      const data = await response.json();
  ...
  const cargarDatosInstancia = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Consultas/obtenerInstancia.php?id_num_guia=${value}`
      );
      const data = await response.json();
    ...
    <Home
      ...
      children2={
        <>
          ...
          <div className="mt-4">
            <NavBarConsultas informacionInstancia={informacionInstancia} />
          </div>
        </>
      }
    />
