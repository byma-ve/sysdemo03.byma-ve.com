...
function HomeProg() {
  ...
  const cargarProgramaciones = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Programacion/obtenerProgramaciones.php"
      );
  ...
  const cargarDatosProgramacion = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Programacion/datosProgramacion.php?id_orden_servicio=${value}`
      );
      const data = await response.json();
  ...
  const cargarSelect = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Programacion/obtenerOrdenServicio.php"
      );
      const data = await response.json();
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Programacion/guardarProgramacion.php",
        {
          method: "POST",
          headers: {
  ...
  const eliminarProgramacion = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Programacion/eliminarProgramacion.php?id=${id}`,
        {
          method: "DELETE",
        }
      );
