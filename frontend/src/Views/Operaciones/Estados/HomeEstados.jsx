...
function HomeEstados() {
  ...
  const cargarSelect = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoRecojos/obtenerRecojos.php"
      );
  ...
  useEffect(() => {
    if (opcionRecojoSeleccionado) {
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoRecojos/obtenerRecojo.php?id_orden_servicio=${opcionRecojoSeleccionado}`
      )
  ...
  const cargarSelectGuia = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/obtenerGuias.php"
      );
      const data = await response.json();
  ...
  useEffect(() => {
    if (opcionRecojoSeleccionadoGuia) {
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/obtenerIntento1.php?id_registro_carga=${opcionRecojoSeleccionadoGuia}`
      )
        .then((response) => response.json())
        .then((data) => {
  ...
  useEffect(() => {
    if (opcionRecojoSeleccionadoGuia) {
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/obtenerIntento2.php?id_registro_carga=${opcionRecojoSeleccionadoGuia}`
      )
        .then((response) => response.json())
        .then((data) => {
  ...
  useEffect(() => {
    if (opcionRecojoSeleccionadoGuia) {
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/obtenerIntento3.php?id_registro_carga=${opcionRecojoSeleccionadoGuia}`
      )
        .then((response) => response.json())
        .then((data) => {
                ...
                <div className="w-[full] overflow-x-auto bg-[#fff] ScrollTable rounded-lg overflow-y-hidden">
                  <table className="w-[100%]  table-fixed text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 whitespace-nowrap ">
                    ...
                    <tbody className=" text-[#535c69]">
                      <tr className="bg-[#fff] border-b border-gray-300 hover:bg-gray-300 ">
                  ...
                  <table className="w-[100%] table-fixed text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400  ">
                    ...
                    <tbody className="  text-[#535c69]">
                      <tr className="bg-[#fff] border-b border-gray-300 hover:bg-gray-300 ">
                        ...
                        <td className="px-6 py-3 gap-x-1 flex justify-center">
                          ...
                          {datosIntento1?.imagen_2_estado_guia && (
                            <>
                              <a
                                href={datosIntento1.imagen_2_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento1?.imagen_3_estado_guia && (
                            <>
                              <a
                                href={datosIntento1.imagen_3_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento1?.imagen_4_estado_guia && (
                            <>
                              <a
                                href={datosIntento1.imagen_4_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento1?.imagen_5_estado_guia && (
                            <>
                              <a
                                href={datosIntento1.imagen_5_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento1?.imagen_6_estado_guia && (
                            <>
                              <a
                                href={datosIntento1.imagen_6_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                      ...
                      <tr className="bg-[#fff] border-b border-gray-300 hover:bg-gray-300 ">
                        ...
                        <td className="px-6 py-3">
                          {datosIntento2?.comentario_estado_guia || ""}
                        </td>
                        <td className="px-6 py-3 gap-x-1 flex  justify-center">
                          {datosIntento2?.imagen_1_estado_guia && (
                            <a
                              href={datosIntento2.imagen_1_estado_guia}
                              target="_blank"
                            >
                              <IconoOjito />
                            </a>
                          ...
                          {datosIntento2?.imagen_2_estado_guia && (
                            <>
                              <a
                                href={datosIntento2.imagen_2_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento2?.imagen_3_estado_guia && (
                            <>
                              <a
                                href={datosIntento2.imagen_3_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento2?.imagen_4_estado_guia && (
                            <>
                              <a
                                href={datosIntento2.imagen_4_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento2?.imagen_5_estado_guia && (
                            <>
                              <a
                                href={datosIntento2.imagen_5_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento2?.imagen_6_estado_guia && (
                            <>
                              <a
                                href={datosIntento2.imagen_6_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                      ...
                      <tr className="bg-[#fff] border-b border-gray-300 hover:bg-gray-300 ">
                        ...
                        <td className="px-6 py-3">
                          {datosIntento3?.comentario_estado_guia || ""}
                        </td>
                        <td className="px-6 py-3  flex  justify-center">
                          {datosIntento3?.imagen_1_estado_guia && (
                            <a
                              href={datosIntento3.imagen_1_estado_guia}
                              target="_blank"
                            >
                              <IconoOjito />
                            </a>
                          ...
                          {datosIntento3?.imagen_2_estado_guia && (
                            <>
                              <a
                                href={datosIntento3.imagen_2_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento3?.imagen_3_estado_guia && (
                            <>
                              <a
                                href={datosIntento3.imagen_3_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento3?.imagen_4_estado_guia && (
                            <>
                              <a
                                href={datosIntento3.imagen_4_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento3?.imagen_5_estado_guia && (
                            <>
                              <a
                                href={datosIntento3.imagen_5_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
                          ...
                          {datosIntento3?.imagen_6_estado_guia && (
                            <>
                              <a
                                href={datosIntento3.imagen_6_estado_guia}
                                target="_blank"
                              >
                                <IconoOjito />
                              </a>
