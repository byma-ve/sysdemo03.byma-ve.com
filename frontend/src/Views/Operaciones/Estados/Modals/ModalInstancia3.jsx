...
export function ModalInstancia3({
  ...
  const ocultarModalInstancia3 = () => {
    setModalInstancia3(false);
  ...
  const [formValues, setFormValues] = useState({
    ...
    num_intento_estado_guia: "intento 3",
    proceso_estado_guia: "",
  ...
  useEffect(() => {
    setFormValues({
      ...
      num_intento_estado_guia:
        datosIntento3?.num_intento_estado_guia || "intento 3",
      proceso_estado_guia: datosIntento3?.proceso_estado_guia || "",
      estado_mercancia_estado_guia:
        datosIntento3?.estado_mercancia_estado_guia || "",
      fecha_proceso_estado_guia: datosIntento3?.fecha_proceso_estado_guia || "",
      comentario_estado_guia: datosIntento3?.comentario_estado_guia || "",
    });
  }, [datosIntento3, modalInstancia3]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/guardarIntento3.php",
        {
          method: "POST",
    ...
    <>
      <div
        className={`side-panel-container ${
          modalInstancia3 ? "visible" : "invisible"
      ...
      >
        <div
          className={`side-panel-cont-container ${
            modalInstancia3 ? "translate-y-0" : "translate-y-[600%]"
              ...
              <div className="side-panel bg-white  rounded-md h-full w-auto m-0   ">
                <div className="side-cont-titulo mb-4 text-xl px-5 py-2   rounded-t-md bg-blue-400 w-full font-semibold text-white">
                  <div className="side-titulo">
                    <h1 className="side-txt uppercase">Instancia 3 </h1>
                  </div>
                </div>
                  ...
                  >
                    <div className=" card-container">
                      ...
                      <div className="flex items-center justify-end mt-8 h-4">
                        ...
                        <button
                          onClick={ocultarModalInstancia3}
                          type="button"
