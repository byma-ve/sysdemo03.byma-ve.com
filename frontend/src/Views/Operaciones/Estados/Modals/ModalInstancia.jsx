...
export function ModalInstancia({
  ...
  const ocultarModalInstancia = () => {
    setModalInstancia(false);
  ...
  const [formValues, setFormValues] = useState({
    ...
    num_intento_estado_guia: "intento 1",
    proceso_estado_guia: "",
  ...
  useEffect(() => {
    setFormValues({
      ...
      num_intento_estado_guia:
        datosIntento1?.num_intento_estado_guia || "intento 1",
      proceso_estado_guia: datosIntento1?.proceso_estado_guia || "",
      estado_mercancia_estado_guia:
        datosIntento1?.estado_mercancia_estado_guia || "",
      fecha_proceso_estado_guia: datosIntento1?.fecha_proceso_estado_guia || "",
      comentario_estado_guia: datosIntento1?.comentario_estado_guia || "",
    });
  }, [datosIntento1, modalInstancia]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/guardarIntento1.php",
        {
          method: "POST",
    ...
    <>
      <div
        className={`side-panel-container ${
          modalInstancia ? "visible" : "invisible"
      ...
      >
        <div
          className={`side-panel-cont-container ${
            modalInstancia ? "translate-y-0" : "translate-y-[600%]"
              ...
              <div className="side-panel bg-white  rounded-md h-full w-auto m-0   ">
                <div className="side-cont-titulo mb-4 text-xl px-5 py-2   rounded-t-md bg-blue-400 w-full font-semibold text-white">
                  <div className="side-titulo">
                    <h1 className="side-txt uppercase">Instancia 1</h1>
                  </div>
                </div>
