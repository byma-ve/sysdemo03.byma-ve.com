...
export function ModalInstancia2({
  ...
  useEffect(() => {
    setFormValues({
      id_num_guia_estado_guia: num_guia,
      num_intento_estado_guia: datosIntento2?.num_intento_estado_guia || 'intento 2',
      proceso_estado_guia: datosIntento2?.proceso_estado_guia || '',
      estado_mercancia_estado_guia: datosIntento2?.estado_mercancia_estado_guia || '',
  ...
  const handleSubmit = async (e) => {
    ...
    formDataWithImage.append("id_num_guia_estado_guia", formValues.id_num_guia_estado_guia);
    formDataWithImage.append("num_intento_estado_guia", formValues.num_intento_estado_guia);
    formDataWithImage.append("proceso_estado_guia", formValues.proceso_estado_guia);
    if (formValues.proceso_estado_guia === "entregado") {
      formDataWithImage.append("estado_mercancia_estado_guia", "entrega exitosa");
    } else {
      formDataWithImage.append("estado_mercancia_estado_guia", formValues.estado_mercancia_estado_guia);
    }
    formDataWithImage.append("fecha_proceso_estado_guia", formValues.fecha_proceso_estado_guia);
    formDataWithImage.append("comentario_estado_guia", formValues.comentario_estado_guia);
    ...
    formDataWithImage.append("id_creador_estado_guia", localStorage.getItem('id_usuario'));
    ...
    try {
      const response = await fetch('https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/EstadoGuias/guardarIntento2.php', {
        method: 'POST',
  ...
  return (
    <>
      <div
        className={`side-panel-container ${modalInstancia2 ? "visible" : "invisible"
          } fixed pointer-events-auto left-0 top-0 right-0 h-full bg-[rgba(0,0,0,0.4)] z-10 flex justify-center items-center`}
      >
        <div
          className={`side-panel-cont-container ${modalInstancia2 ? "translate-y-0" : "translate-y-[600%]"
                        ...
                        <div className="py-2">
                          <div>
                            ...
                            <textarea
                              ...
                              className="uppercase w-[305%] px-1 border rounded-sm  focus:outline-none focus:ring-2 ring-1 focus:border-blue-500  "
                            />
                          </div>
