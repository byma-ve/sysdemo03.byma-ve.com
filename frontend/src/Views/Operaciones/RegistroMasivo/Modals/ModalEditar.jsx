...
function EditarEnvio({
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroMasivo/totalTarifa.php`,
          {
            method: "POST",
            headers: {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroMasivo/cargosAdicionales.php`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    if (id_cliente && id_area && id_destino_cotizacion) {
      try {
        const response = await fetch(
          "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroMasivo/editarDestino.php",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
