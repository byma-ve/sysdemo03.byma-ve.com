...
function DatosRemitente({ onClienteElegido, onAreaElegida }) {
  ...
  useEffect(() => {
    fetch(
      "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Cliente/obtenerClientesTarifarios.php"
    )
  ...
  useEffect(() => {
    if (clienteElegido) {
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Area/obtenerAreasTarifario.php?id_cliente=${clienteElegido}`
      )
        .then((response) => response.json())
        .then((data) => {
        ...
        <div className="side-panel bg-[#fff] rounded-2xl">
          <div className="side-cont-titulo  text-[18px] font-semibold text-[#535c69]">
            <div className="side-titulo ">
              <h1 className="side-txt text-white py-2 px-5 mb-2 bg-blue-400 rounded-t-xl">
                Datos del Cliente
              </h1>
            </div>
          </div>
          <div className="section-crm ">
            <div className="card-container">
              <div className="flex px-5">
                <div className="cont-elegir-cliente flex flex-col w-full">
