...
function HomeCarga() {
  ...
  const cargarOpciones = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroCarga/obtenerRegistrosCarga.php"
      );
  ...
  const cargarDatosRegistro = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroCarga/obtenerRegistro.php?id_orden_servicio_id_destino=${value}`
      );
      const data = await response.json();
  ...
  const cargarDatosNumeroRegistro = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroCarga/obtenerDatosNumeroRegistro.php?id_orden_servicio_id_destino=${value}`
      );
      const data = await response.json();
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroCarga/guardarRegistro.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleFormSubmitMasivo = async (event) => {
    ...
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroCarga/guardarRegistrosMasivo.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
