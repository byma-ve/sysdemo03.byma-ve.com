...
import LogoHorizontal from "../../../../Static/Img_Pred/Logopdf.png";

const obtenerDatosSticker = async (id) => {
  try {
    const response = await fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Consultas/obtenerConsulta.php?id_num_guia=${id}`
    );
