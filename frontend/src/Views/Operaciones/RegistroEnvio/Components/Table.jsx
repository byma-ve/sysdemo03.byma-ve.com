            ...
            <tbody className="text-left text-[#535c69] whitespace-nowrap block">
              ...
              {cotizacionesFiltrados &&
                cotizacionesActuales.map((cotizacion, index) => (
                  <tr
                    key={cotizacion.id}
                    className={` border-b ${cotizacion.validacion_cotizacion === "Enviado a validar"
                        ? "hover:bg-green-200"
                        : "hover:bg-gray-300"
                  ...
                  >
                    ...
                    <td className="px-5 py-4 ">{cotizacion.fecha_creado}</td>
                    <td className="px-10 py-4 ">{cotizacion.id_cotizacion}</td>
                    ...
                    <td className="px-10 py-4 ">{cotizacion.email_cliente}</td>
