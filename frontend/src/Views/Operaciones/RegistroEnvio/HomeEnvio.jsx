...
function HomeEnvio() {
  ...
  const cargarListaEnvios = async () => {
    try {
      const response = await fetch(`https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroEnvio/obtenerListaDestinos.php?id_cliente=${clienteElegido}&id_area=${areaElegida}`);
  ...
  const cargarTabla = async () => {
    try {
      const response = await fetch('https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroEnvio/obtenerCotizaciones.php');
      const data = await response.json();
  ...
  const eliminarCotizacion = async (id) => {
    try {
      const response = await fetch(`https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/RegistroEnvio/eliminarCotizacion.php?id_cotizacion=${id}`, {
        method: 'GET',
      });
