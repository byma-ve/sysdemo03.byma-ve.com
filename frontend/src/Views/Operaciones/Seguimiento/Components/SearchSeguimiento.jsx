...
const SearchSeguimiento = ({ titlle, onSearch }) => {
  ...
  async function descargarExcel() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Seguimiento/exportarSeguimiento.php?id_cliente=${idCliente}&id_area=${idArea}&fechaDesde=${fechaDesde}&fechaHasta=${fechaHasta}`;
