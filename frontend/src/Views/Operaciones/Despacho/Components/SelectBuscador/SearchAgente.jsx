    ...
    <Combobox value={selectedAgente} onChange={handleSelectAgente}>
      ...
      >
        {filteredAgentes.length > 0 ? (
          <Combobox.Options className="absolute mt-1 max-h-60 overflow-auto w-[135px] rounded-sm bg-white py-1 text-base shadow-lg focus:outline-none sm:text-sm z-10">
