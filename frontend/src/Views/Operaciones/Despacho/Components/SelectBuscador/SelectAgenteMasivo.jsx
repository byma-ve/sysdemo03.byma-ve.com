...
export default function SearchAgenteMasivo({
  agentes,
  setSelectedAgente,
  selectedAgenteEnvio
  ...
  return (
    <Combobox value={selectedAgente} onChange={handleSelectAgente}>
      <div className="w-[90%] mt-1 h-5 text-xs bg-gray-100 px-1 rounded-sm border focus:outline-none focus:ring-0 focus:border-blue-500 focus:shadow-md flex truncate">
        ...
        />
        <Combobox.Button className=" items-center bottom-5  cursor-default">
          <IconoAbajo
      ...
      >
        {filteredAgentes.length > 0 ? (
          <Combobox.Options className="absolute mt-1 max-h-60 overflow-auto w-[135px] rounded-sm bg-gray-100 py-1 text-base shadow-lg focus:outline-none sm:text-sm z-10">
