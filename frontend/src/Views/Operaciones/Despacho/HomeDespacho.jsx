...
function HomeDespacho() {
  ...
  useEffect(() => {
    fetch(
      `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerAgentesManifiesto.php?num_manifiesto=${selectedDespacho}`
    )
  ...
  useEffect(() => {
    ...
    fetch(
      "https://sysdemo03.byma-ve.com/BackendApiRest/Ubigeo/select_ubigeo.php?action=departamentos"
    )
      .then((response) => response.json())
  ...
  useEffect(() => {
    if (departamentoSeleccionado) {
      ...
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Ubigeo/select_ubigeo.php?action=provincias&id=${departamentoSeleccionado}`
      )
        .then((response) => response.json())
  ...
  useEffect(() => {
    if (provinciaSeleccionada) {
      ...
      fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Ubigeo/select_ubigeo.php?action=distritos&id=${provinciaSeleccionada}`
      )
        .then((response) => response.json())
  ...
  const cargarConductores = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Usuario/obtenerConductores.php"
      );
  ...
  const cargarAuxiliares = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Usuario/obtenerAuxiliares.php"
      );
      const data = await response.json();
  ...
  const cargarVehiculos = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Vehiculo/obtener_vehiculos.php"
      );
      const data = await response.json();
  ...
  const cargarDatosVehiculo = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Vehiculo/obtenerVehiculo.php?id=${value}`
      );
      const data = await response.json();
  ...
  const cargarGuiasUnitario = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerGuiasUnitarias.php"
      );
      const data = await response.json();
  ...
  const cargarDatosGuiaUnitaria = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerGuiaUnitaria.php?id_num_guia_registro_carga=${value}`
      );
      const data = await response.json();
  ...
  const cargarAgentes = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Proveedor/obtener_agentes.php"
      );
      const data = await response.json();
  ...
  const cargarDatosAgente = async (value) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Proveedor/obtener_datos_proveedor.php?id=${value}`
      );
      const data = await response.json();
      setDatosAgente(data);
    } catch (error) {
  ...
  const cargarGuiasMasivas = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerGuiasMasivas.php"
      );
      const data = await response.json();
  ...
  const cargarListaEnvios = async (valorExtra) => {
    try {
      let url;
      if (valorExtra) {
        url = `https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerListaTransportista.php?id=${valorExtra}`;
      } else {
        url =
          "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerListaEnvios.php";
      }
  ...
  const cargarDespachos = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/obtenerDespachos.php"
      );
      const data = await response.json();
  ...
  const handleSubmitDespacho = async (event) => {
    ...
    `,
      ...
      try {
        const response = await fetch(
          "https://sysdemo03.byma-ve.com/BackendApiRest/Operaciones/Despacho/guardarDespacho.php",
          {
            method: "POST",
            headers: {
