...
function TrabExternos({ formValues, handleChange }) {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Proveedor/obtener_proveedores.php"
    )
  ...
  useEffect(() => {
    if (formValues.id_proveedor_recojo) {
      ...
      if (selected) {
        ...
        fetch(
          `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Proveedor/obtener_datos_proveedor.php?id=${selected.id}`
        )
          .then((response) => response.json())
          .then((data) => {
    ...
    <>
      ...
      <form className="mb-1 text-black">
        ...
        <div className="grid grid-cols-4 pl-5 gap-0">
          <div className=" ">
            <label className=" text-xs ">Tipo Prov:</label>
          </div>
          ...
          <div className="">
            <label className=" text-xs">Tipo Serv:</label>
          </div>
          <div className="ml-[-25px]">
            <input
              type="text"
