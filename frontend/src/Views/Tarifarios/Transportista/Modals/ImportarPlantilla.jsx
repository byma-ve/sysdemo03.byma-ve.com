...
export const ImportarPlantilla = ({ modalMasivo, setModalMasivo, id_transportista, tarifario, actualizarTabla }) => {
  ...
  const enviarDatos = async () => {
    ...
    try {
      ...
      let apiUrl;
      if (tarifario === "Courier") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Transportista/guardarCourrier.php`;
      }
      if (tarifario === "Carga") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Transportista/guardarCarga.php`;
      }
      ...
      >
        <div
          className={`side-panel-cont-container ${
            modalMasivo ? "translate-y-0" : "translate-y-[600%]"
