  ...
  const cargarTabla = async () => {
    try {
      ...
      if (selectedOption === "Courier") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Transportista/obtenerCourrier.php?id_transportista=${encodeURIComponent(
          selectedAgente
        )}`;
      }
      if (selectedOption === "Carga") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Transportista/obtenerCarga.php?id_transportista=${encodeURIComponent(
          selectedAgente
        )}`;
      }
