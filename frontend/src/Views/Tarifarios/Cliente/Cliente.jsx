  ...
  const cargarTabla = async () => {
    try {
      ...
      if (selectedOption === "Courier") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Cliente/obtener_tarifario_courrier.php?id_cliente=${encodeURIComponent(
          selectedCliente
        )}&id_area=${encodeURIComponent(selectedArea)}`;
      }
      if (selectedOption === "Aereo") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Cliente/obtener_tarifario_aereo.php?id_cliente=${encodeURIComponent(
          selectedCliente
        )}&id_area=${encodeURIComponent(selectedArea)}`;
      }
      if (selectedOption === "Valorizado") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Cliente/obtener_tarifario_valorizado.php?id_cliente=${encodeURIComponent(
          selectedCliente
        )}&id_area=${encodeURIComponent(selectedArea)}`;
      }
      if (selectedOption === "Carga") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Cliente/obtener_tarifario_carga.php?id_cliente=${encodeURIComponent(
          selectedCliente
        )}&id_area=${encodeURIComponent(selectedArea)}`;
      }
