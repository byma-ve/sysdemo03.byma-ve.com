  ...
  const enviarDatos = async () => {
    ...
    try {
      ...
      if (tarifario === "Courier") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Agente/guardarCourrier.php`;
      }
      if (tarifario === "Aereo") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Agente/guardarAereo.php`;
      }
