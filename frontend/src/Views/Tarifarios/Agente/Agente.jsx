  ...
  const cargarTabla = async () => {
    try {
      ...
      if (selectedOption === "Courier") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Agente/obtenerCourrier.php?id_agente=${encodeURIComponent(
          selectedAgente
        )}`;
      }
      if (selectedOption === "Aereo") {
        apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Tarifarios/Agente/obtenerAereo.php?id_agente=${encodeURIComponent(
          selectedAgente
        )}`;
      }
