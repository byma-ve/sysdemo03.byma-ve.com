...
function ModalEditarCliente({
  ...
  useEffect(() => {
    fetch(
      "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Usuario/obtener_vendedores.php"
    )
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Cliente/actualizar_cliente.php",
        {
          method: "POST",
