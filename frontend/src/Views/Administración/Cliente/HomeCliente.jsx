...
const CrearCliente = () => {
  ...
  const exportarClientes = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Cliente/exportar_clientes.php"
      );
  ...
  const eliminarCliente = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Cliente/eliminar_cliente.php?id=${id}`,
        {
          method: "DELETE",
        }
      );
