...
const CrearProveedor = () => {
  ...
  const exportarProveedores = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Proveedor/exportar_proveedores.php"
      );
  ...
  const eliminarProveedor = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Proveedor/eliminar_proveedor.php?id=${id}`,
        {
          method: "DELETE",
        }
      );
