...
const CrearVehiculo = () => {
  ...
  const exportarVehiculos = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Vehiculo/exportar_vehiculos.php"
      );
  ...
  const eliminarVehiculo = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Vehiculo/eliminar_vehiculo.php?id=${id}`,
        {
          method: "DELETE",
        }
      );
