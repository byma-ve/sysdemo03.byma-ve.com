...
const CrearUsuario = () => {
  ...
  const exportarUsuarios = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Usuario/exportar_usuario.php"
      );
  ...
  const cargarTabla = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Usuario/obtener_usuarios.php"
      );
      const data = await response.json();
      setUsuarios(data);
    } catch (error) {
  ...
  const eliminarUsuario = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Usuario/eliminar_usuario.php?id=${id}`,
        {
          method: "DELETE",
        }
      );
