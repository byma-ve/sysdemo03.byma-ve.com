...
const Area = () => {
  ...
  const exportarAreas = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Area/exportar_areas.php"
      );
  ...
  const cargarTabla = async () => {
    try {
      const response = await fetch(
        "https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Area/obtener_areas.php"
      );
      const data = await response.json();
      setAreas(data);
    } catch (error) {
  ...
  const eliminarArea = async (id) => {
    try {
      const response = await fetch(
        `https://sysdemo03.byma-ve.com/BackendApiRest/Administracion/Area/eliminar_area.php?id=${id}`,
        {
          method: "DELETE",
        }
      );
