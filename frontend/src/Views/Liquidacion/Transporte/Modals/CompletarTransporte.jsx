...
function CTransporte({ modalVisible, setModalVisible, selectedData, actualizarTabla }) {
  ...
  const [formValues, setFormValues] = useState({
    ...
    num_manifiesto_liquidacion_transportista: '',
    num_documento_liquidacion_transportista: '',
    tipo_documento_liquidacion_transportista: '',
    estado_documento_liquidacion_transportista: '',
  });
  ...
  useEffect(() => {
    setFormValues({
      nombre_transportista: selectedData?.razon_social_proveedor || '',
      num_manifiesto_liquidacion_transportista: selectedData?.id_num_manifiesto_despacho || '',
      num_documento_liquidacion_transportista: selectedData?.numero_documento || '',
      tipo_documento_liquidacion_transportista: selectedData?.tipo_documento || '',
      estado_documento_liquidacion_transportista: selectedData?.estado_documento || '',
    });
  ...
  const handleSubmit = async (e) => {
    ...
    formDataWithImage.append("nombre_transportista", formValues.nombre_transportista);
    formDataWithImage.append("num_manifiesto_liquidacion_transportista", formValues.num_manifiesto_liquidacion_transportista);
    formDataWithImage.append("num_documento_liquidacion_transportista", formValues.num_documento_liquidacion_transportista);
    formDataWithImage.append("tipo_documento_liquidacion_transportista", formValues.tipo_documento_liquidacion_transportista);
    formDataWithImage.append("estado_documento_liquidacion_transportista", formValues.estado_documento_liquidacion_transportista);
    formDataWithImage.append("pdf_liquidacion_transportista", pdfLiquidacion);
    ...
    try {
      const response = await fetch('https://sysdemo03.byma-ve.com/BackendApiRest/Liquidacion/LiquidacionTransportista/guardarLiquidacion.php', {
        method: 'POST',
                    ...
                    <div className="card-container">
                      <form onSubmit={handleSubmit} encType="multipart/form-data" className="text-black">
                        <div className="relative z-0 w-full mb-6 group ">
                          <input
                            type="text"
                            name="tipo_documento_liquidacion_transportista"
                            id="tipo_documento_liquidacion_transportista"
                            ...
                            value={formValues.tipo_documento_liquidacion_transportista}
                            onInput={event => {
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                          <input
                            type="text"
                            name="num_documento_liquidacion_transportista"
                            id="num_documento_liquidacion_transportista"
                            className="uppercase block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none  border-gray-400 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" "
                            required
                            onChange={handleChange}
                            value={formValues.num_documento_liquidacion_transportista}
                            onInput={event => {
                              event.target.value = event.target.value.toUpperCase();
                            }}
                          />
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                          <input
                            type="file"
                            name="pdf_liquidacion_transportista"
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                          <input
                            type="text"
                            name="estado_documento_liquidacion_transportista"
                            id="estado_documento_liquidacion_transportista"
                            className="uppercase block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 appearance-none  border-gray-400 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" "
                            required
                            onChange={handleChange}
                            value={formValues.estado_documento_liquidacion_transportista}
                            onInput={event => {
                              event.target.value = event.target.value.toUpperCase();
                            }}
                          />
