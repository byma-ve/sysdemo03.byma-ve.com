...
function Filtrado({ onSearch }) {
  ...
  async function descargarExcel() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Liquidacion/LiquidacionTransportista/exportarLiquidacionTransportista.php?id_transportista=${idAgente}&fechaDesde=${fechaDesde}&fechaHasta=${fechaHasta}`;
