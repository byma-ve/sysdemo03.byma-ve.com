...
export default function SearchVendedor({ agentes, handleSelectAgente }) {
  ...
  return (
    <div className=" relative flex z-[3] mx-4">
      <Combobox value={selected}
        ...
        <div className=" ">
          <div className="relative w-[16.8rem] cursor-default overflow-hidden rounded-lg text-left  focus:outline-none   sm:text-sm 
        ...
        border-none   outline-none">
            <Combobox.Input
              ...
              displayValue={(value) =>
                typeof value === "string" ? "Todos" : value.colaborador_usuario
              }
          ...
          >
            <Combobox.Options className="absolute mt-1 max-h-60 w-full ScrollTableVertical overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
              <Combobox.Option
                className={({ active }) =>
                  `relative cursor-default select-none py-2 pl-10 pr-4  ${active ? "bg-gray-300 text-white" : "text-gray-900"
                  }`
                }
                value=""
              >
