...
function Filtrado({ onSearch }) {
  ...
  async function descargarExcel() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Liquidacion/LiquidacionVendedor/exportarLiquidacionVendedor.php?id_usuario=${idAgente}&fechaDesde=${fechaDesde}&fechaHasta=${fechaHasta}`;
