...
function Filtrado({ onSearch }) {
  ...
  async function descargarExcel() {
    ...
    try {
      ...
      const apiUrl = `https://sysdemo03.byma-ve.com/BackendApiRest/Liquidacion/LiquidacionAgente/exportarLiquidacionAgente.php?id_agente=${idAgente}&fechaDesde=${fechaDesde}&fechaHasta=${fechaHasta}`;
