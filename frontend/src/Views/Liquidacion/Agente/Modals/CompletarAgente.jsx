...
function CAgente({ modalVisible, setModalVisible, selectedData, actualizarTabla }) {
  ...
  useEffect(() => {
    setFormValues({
      ...
      num_documento_liquidacion_agente: selectedData?.num_documento_liquidacion_agente || '',
      tipo_documento_liquidacion_agente: selectedData?.tipo_documento_liquidacion_agente || '',
      estado_documento_liquidacion_agente: selectedData?.estado_documento_liquidacion_agente || '',
    });
  ...
  const handleSubmit = async (e) => {
    ...
    formDataWithImage.append("num_manifiesto_liquidacion_agente", formValues.num_manifiesto_liquidacion_agente);
    formDataWithImage.append("id_agente_liquidacion_agente", formValues.id_agente_despacho_envio);
    formDataWithImage.append("num_documento_liquidacion_agente", formValues.num_documento_liquidacion_agente);
    formDataWithImage.append("tipo_documento_liquidacion_agente", formValues.tipo_documento_liquidacion_agente);
    formDataWithImage.append("estado_documento_liquidacion_agente", formValues.estado_documento_liquidacion_agente);
    ...
    try {
      const response = await fetch('https://sysdemo03.byma-ve.com/BackendApiRest/Liquidacion/LiquidacionAgente/guardarLiquidacionAgente.php', {
        method: 'POST',
                      ...
                      <form onSubmit={handleSubmit} encType="multipart/form-data" className="text-black">
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                          <input
                            ...
                            required
                            onChange={handleChange}
                            value={formValues.estado_documento_liquidacion_agente}
                            onInput={event => {
                              event.target.value = event.target.value.toUpperCase();
                            }}
                          />
